...
work_dir = None
resume_from = "./work_dirs/M2M_nusc_v299_fusion_full_2Phase_22n22ep/epoch_12.pth"
...
point_cloud_range = [-15.0, -30.0, -10.0, 15.0, 30.0, 10.0] #LSS also use
voxel_size = [0.15, 0.15, 20.0] # LSS also use
dbound = [1.0, 35.0, 0.5]

lidar_point_cloud_range = [-15.0, -30.0, -5.0, 15.0, 30.0, 3.0]
lidar_voxel_size = [0.1, 0.1, 0.2]
# lidar_voxel_size = [0.1, 0.1, 8.0] # turned into pillar mode?
...
model = dict(
    ...
    lidar_encoder=dict(
        ...
        backbone=dict( # replace with PointPillarsScatter
            type='SparseEncoder',
            in_channels=5,
